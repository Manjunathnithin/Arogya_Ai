...
# Import the new ConnectionRequestInput model
...
async def create_connection_request(
    ...
    request_dict["patient_email"] = current_user.email # <--- FIX: Injecting patient_email
...
# --- Doctor Routes (Remainder of the file remains the same) ---
